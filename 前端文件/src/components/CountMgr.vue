...
export default {
    ...
    methods: {
        ...
        getMonthMoney() {
            let moneyDiv = this.$echarts.init(document.getElementById("money"));
            this.axios
        ...
        getMonthOrder() {
            let orderDiv = this.$echarts.init(document.getElementById("order"));
            this.axios
        ...
        getMonthKind() {
            let kindDiv = this.$echarts.init(document.getElementById("kind"));
            this.axios
                .get(
