    ...
    <div class="container ml-3">
        <form class="row">
            <div class="form-group col-lg-5">
                书籍名称：
                <input v-model="addName" type="text" class="form-control"> 国际书籍编号：
                <input v-model="addISBN" type="text" class="form-control"> 作者：
                <input v-model="addAuthor" type="text" class="form-control"> 出版社：
                <input v-model="addPublilsh" type="text" class="form-control"> 出版时间：
                <input v-model="addPublTime" type="date" class="form-control"> 书籍分类：
                <input v-model="addKind" type="text" class="form-control"> 价格：
                <input v-model="addPrice" type="text" class="form-control"> 库存：
                <input v-model="addStorage" type="text" class="form-control">
            </div>
            <div class="form-group col-lg-7 pl-5">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <input @click="addBook()" class="btn btn-primary btn-block btn-sm mt-2" type="submit" value="确定">
                    </div>
                </div>
            </div>
        </form>
