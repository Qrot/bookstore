                            ...
                            <div class="modal-dialog modal-md">
                                <div class="modal-content">
                                        ...
                                        <div class="form-label-group ml-2 mr-2">
                                            ...
                                            <input type="text" v-model="username" id="inputEmail" class="form-control" placeholder="Email address" required autofocus>
                                        ...
                                        <div class="checkbox mb-3 ml-2">
                                            <label>
                                                <input type="checkbox" value="remember-me"> 记住
                                            </label>
                                        </div>
                                        <button class="btn btn-md btn-primary btn-block"  v-on:click="login" data-dismiss="modal">登录</button>
